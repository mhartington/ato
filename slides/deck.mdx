...
import repo from './imgs/ionic-v1.png'

<Image src={repo}  size="contain"/>
...
### Other Places
- `IonRouterOutlet`: extends Angular Router
- `@ionic/angular-toolkit`: extend Angular Builders
- `ng generate page`: extends Angular Schematics
...
import seldo from './imgs/seldo-tweet.png';
...
- But Frameworks are helpful

---

<Image src={repo}  size="contain"/>

_INSERT NICOLE SULIVAN QUOTE_

---

### Bring Ionic to more developers

---

Make building app easy, regardless of technology of choice
